...
int main(int argc, char **argv)  {
   ...
   if(argc < 2){
    ...
    for(i=0; i<tam; i+=4){
    	...
    	m1[i+1] = (double*) malloc(tam*sizeof(double));
    	m1[i+2] = (double*) malloc(tam*sizeof(double));
    	m1[i+3] = (double*) malloc(tam*sizeof(double));
        m2[i] = (double*) malloc(tam*sizeof(double));
    	m2[i+1] = (double*) malloc(tam*sizeof(double));
    	m2[i+2] = (double*) malloc(tam*sizeof(double));
    	m2[i+3] = (double*) malloc(tam*sizeof(double));
    	m3[i] = (double*) malloc(tam*sizeof(double));
    	m3[i+1] = (double*) malloc(tam*sizeof(double));
    	m3[i+2] = (double*) malloc(tam*sizeof(double));
    	m3[i+3] = (double*) malloc(tam*sizeof(double));
    }
